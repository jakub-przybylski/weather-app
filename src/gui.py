...
def run_app():
    ...
    label_name = ctk.CTkLabel(root, text="city", font=("Roboto", 32,"bold"))
    label_name.grid(row=1, column=0, columnspan=2, padx=10, pady=5)

    # temperature in the city
    label_temperature = ctk.CTkLabel(root, text="20", font=("Roboto", 32,"bold"))
    label_temperature.grid(row=2, column=0, columnspan=2, padx=10, pady=5)

    # description of the weather in the city
    label_description = ctk.CTkLabel(root, text="description", font=("Roboto", 32,"bold"))
    label_description.grid(row=3, column=0, columnspan=2, padx=10, pady=5)

    # perceived temperature
    label_perceivedTemperature = ctk.CTkLabel(root, text="Perceived: 20", font=("Roboto", 16))
    label_perceivedTemperature.grid(row=4, column=0, padx=10, pady=5)

    # wind
    label_wind = ctk.CTkLabel(root, text="Wind: 20", font=("Roboto", 16))
